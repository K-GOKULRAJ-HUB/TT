            ...
            <c:choose>
                <c:when test="${not empty sessionScope.user}">
                    <c:if test="${sessionScope.user.role eq 'BUYER'}">
                        <li><a href="${pageContext.request.contextPath}/cart" class="nav-link">Shopping Cart</a></li>
                    ...
                    <c:if test="${sessionScope.user.role eq 'SELLER'}">
                        ...
                        <li><a href="${pageContext.request.contextPath}/seller/orders" class="nav-link">Manage Orders</a></li>
                    </c:if>
                    <c:if test="${sessionScope.user.role eq 'ADMIN'}">
                        ...
                        <li><a href="${pageContext.request.contextPath}/admin/products" class="nav-link">All Listings</a></li>
                    </c:if>
